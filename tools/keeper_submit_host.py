#!/usr/bin/env python3
"""Private Linux host with bounded signed job registration. No automatic selection."""
import sys
...
def main():
    ...
    from par_job_submit.host import SubmissionHost
    ...
    try:
        ...
        with owned_verified(a.root,a.spool,cfg,p,bytes(secret),mode=a.verification_mode,allow_unpatched_sqlite=a.allow_unpatched_sqlite) as (k,g,cache,startup):
            ...
            with SubmissionHost(k,g,a.socket,a.upload_socket,a.control_socket,a.submit_socket,a.jobs,a.control_state,a.submissions,public,a.control_revision,expected_jobs_pin=jp,expected_control_pin=cp,
