...
def step(tid):
    ...
    cp=checkpoint(ROOT,s['id'],'Read plan/NEXT_SDK_EVENT_BINDING_0037.ja.md. Encrypted local events and explicit ack differ from latest snapshots and volatile presence. TypeScript/native/remote event bindings, real CRDT and production gates remain unverified.')
