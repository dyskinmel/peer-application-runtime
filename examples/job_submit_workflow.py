...
def step(tid):
    ...
    cp=checkpoint(ROOT,s['id'],'Read plan/NEXT_JOB_SUBMISSION_RETIRE.ja.md. Signed bounded live job registration is implemented; stage reclamation, native/public transport, CRDT and writable recovery remain unverified.')
