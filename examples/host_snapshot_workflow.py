...
INDEX=ROOT/'.harness/host-snapshot-workflow-index.json'
def step(tid):
    ...
    cp=checkpoint(ROOT,s['id'],'Read plan/NEXT_HOST_MANAGEMENT_JOBS.ja.md. Exact positive signature reuse and bounded-reader improvements are local candidates; authorization/disk checks remain live. Management jobs, native/public transport, CRDT and writable recovery remain unverified.')
