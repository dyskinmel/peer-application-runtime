...
TASKS=['H0-SELFTEST','G0-WIRE-LOCAL','G0-STORE-LOCAL','G0-CRYPTO-LOCAL','SPACE-AUTH-LOCAL','AUTH-STORE-LOCAL','BLOB-STORE-LOCAL','BLOB-MANIFEST-LOCAL','RECOVERY-CLOSURE-LOCAL','KEEPER-RETENTION-LOCAL','KEEPER-GC-LOCAL']
INDEX=ROOT/'.harness/keeper-gc-workflow-index.json'
def step(tid):
    ...
    cp=checkpoint(ROOT,s['id'],'Read plan/NEXT_KEEPER_REPAIR.ja.md. Explicit local released-lease reclamation is implemented; repair, cross-process reader streaming, network, CRDT, native and production qualification remain unverified.')
