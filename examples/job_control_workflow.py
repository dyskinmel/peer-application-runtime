...
def step(tid):
    ...
    cp=checkpoint(ROOT,s['id'],'Read plan/NEXT_HOST_JOB_SUBMIT.ja.md. Private pre-registered job control is a local candidate; live job submission, preemptive effects, native/public transport, CRDT and writable recovery remain unverified.')
