...
def step(tid):
    ...
    cp=checkpoint(ROOT,s['id'],'Read plan/NEXT_JOB_SUBMISSION_RETIRE_CONTROL.ja.md. Dual-authorized local payload retirement is implemented; remote retirement control, record GC, native/public transport, CRDT and writable recovery remain unverified.')
