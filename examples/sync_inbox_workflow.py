...
INDEX=ROOT/'.harness/sync-inbox-workflow-index.json'
def step(tid):
    ...
    cp=checkpoint(ROOT,s['id'],'Read plan/NEXT_CAUSAL_SYNC_0033.ja.md. Signed pending inbox, causal readiness and restart tested; actual Automerge, durable application, public transport and product gates remain unverified.')
