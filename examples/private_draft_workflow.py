...
INDEX=ROOT/'.harness/private-draft-workflow-index.json'
def step(tid):
    ...
    cp=checkpoint(ROOT,s['id'],'Read plan/NEXT_REFERENCE_RUNTIME_BINDING.ja.md. Local renderer and encrypted private drafts are candidates; shared runtime, actual-origin IndexedDB, native IME and CRDT remain unverified. L-WP11 remains partial.')
