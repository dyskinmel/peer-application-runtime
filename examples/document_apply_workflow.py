...
INDEX=ROOT/'.harness/document-apply-workflow-index.json'
def step(tid):
    ...
    cp=checkpoint(ROOT,s['id'],'Read plan/NEXT_REAL_APPLICATION_0035.ja.md. Atomic candidate application contracts are implemented; actual Automerge, native durable apply, UI shared effects and product gates remain unverified.')
