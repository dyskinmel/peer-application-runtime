...
INDEX=ROOT/'.harness/reference-presenter-workflow-index.json'
def step(tid):
    ...
    cp=checkpoint(ROOT,s['id'],'Read plan/NEXT_REFERENCE_RENDERER.ja.md. Pure Presenter and volatile draft logic are implemented; rendered UI, runtime effects, real IME and CRDT remain unverified. L-WP11 remains partial.')
