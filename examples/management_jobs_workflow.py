...
def step(tid):
    ...
    cp=checkpoint(ROOT,s['id'],'Read plan/NEXT_HOST_JOB_SCHEDULER.ja.md. Durable cooperative owner jobs are local candidates; live host scheduling, native/public transport, CRDT and writable recovery remain unverified.')
