...
def step(tid):
    ...
    cp=checkpoint(ROOT,s['id'],'Read plan/NEXT_SHARED_DOCUMENT_CONTRACT.ja.md. Read-only authenticated local Store observations and operation inquiries are connected. Shared writes, real-origin IndexedDB, native IME, Automerge and production remain unverified.')
