...
INDEX=ROOT/'.harness/shared-document-workflow-index.json'
def step(tid):
    ...
    cp=checkpoint(ROOT,s['id'],'Read plan/NEXT_ACTUAL_CORE_0032.ja.md. Inner/outer admission and Store candidate tested with explicit synthetic semantic port; real Automerge/merge, durable apply and product gates remain unverified.')
