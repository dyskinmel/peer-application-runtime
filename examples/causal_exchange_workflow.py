...
INDEX=ROOT/'.harness/causal-exchange-workflow-index.json'
def step(tid):
    ...
    cp=checkpoint(ROOT,s['id'],'Read plan/NEXT_DOCUMENT_APPLY_0034.ja.md. Private causal reads and explicit pending transfer tested; actual Automerge, durable apply, public transport and product gates remain unverified.')
