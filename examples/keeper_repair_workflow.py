...
TASKS=['H0-SELFTEST','G0-WIRE-LOCAL','G0-STORE-LOCAL','G0-CRYPTO-LOCAL','SPACE-AUTH-LOCAL','AUTH-STORE-LOCAL','BLOB-STORE-LOCAL','BLOB-MANIFEST-LOCAL','RECOVERY-CLOSURE-LOCAL','KEEPER-RETENTION-LOCAL','KEEPER-GC-LOCAL','KEEPER-REPAIR-LOCAL']
INDEX=ROOT/'.harness/keeper-repair-workflow-index.json'
def step(tid):
    ...
    cp=checkpoint(ROOT,s['id'],'Read plan/NEXT_KEEPER_SERVICE.ja.md. Explicit inventory-bound local repair and GC are implemented; private cross-process service, native, CRDT, writable recovery and production qualification remain unverified.')
