...
INDEX=ROOT/'.harness/event-binding-workflow-index.json'
def step(tid):
    ...
    cp=checkpoint(ROOT,s['id'],'Read plan/NEXT_EVENT_HOST_PORT_0038.ja.md. Typed batches require explicit acknowledgment; fixture owner bridge is not production transport. Native/remote event bindings, real CRDT and production gates remain unverified.')
