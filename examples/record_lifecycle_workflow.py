...
def step(tid):
    ...
    cp=checkpoint(ROOT,s['id'],'Read plan/NEXT_REFERENCE_PRESENTER.ja.md and plan/PRODUCT_REBASELINE_0027.ja.md. Real ledger inventory is non-destructive; closure/compaction is a pure model only. No product qualification. Next existing L-WP11; real CRDT remains unverified.')
