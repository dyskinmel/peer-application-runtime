...
def step(tid):
    ...
    cp=checkpoint(ROOT,s['id'],'Read plan/NEXT_CORE_OR_EVENTS_0036.ja.md. Read-only schema4 observations hide candidate content; actual-core replay is only simulated in contract tests. Shared writes, actual Automerge and production gates remain unverified.')
