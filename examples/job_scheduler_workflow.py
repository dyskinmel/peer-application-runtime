...
def step(tid):
    ...
    cp=checkpoint(ROOT,s['id'],'Read plan/NEXT_HOST_JOB_CONTROL.ja.md. Measured private host drain and explicit owner scheduling are local candidates; live control IPC, preemptive effects, native/public transport, CRDT and writable recovery remain unverified.')
