...
TASKS=['H0-SELFTEST','G0-WIRE-LOCAL','G0-STORE-LOCAL','G0-CRYPTO-LOCAL','SPACE-AUTH-LOCAL','AUTH-STORE-LOCAL','BLOB-STORE-LOCAL','BLOB-MANIFEST-LOCAL','RECOVERY-CLOSURE-LOCAL']
INDEX=ROOT/'.harness/recovery-workflow-index.json'
def step(tid):
    ...
    cp=checkpoint(ROOT,s['id'],'Read plan/NEXT_KEEPER_RETENTION.ja.md. Recipient read-only recovery is implemented for a pinned current epoch; CRDT apply, durable Keeper/network, native and production qualification remain unverified.')
