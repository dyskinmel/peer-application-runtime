...
TASKS=['H0-SELFTEST','G0-WIRE-LOCAL','G0-STORE-LOCAL','G0-CRYPTO-LOCAL','SPACE-AUTH-LOCAL','AUTH-STORE-LOCAL','BLOB-STORE-LOCAL','BLOB-MANIFEST-LOCAL','RECOVERY-CLOSURE-LOCAL','KEEPER-RETENTION-LOCAL','KEEPER-GC-LOCAL','KEEPER-REPAIR-LOCAL','KEEPER-SERVICE-LOCAL','KEEPER-SERVICE-UPLOAD-LOCAL','KEEPER-UPLOAD-RETIRE-LOCAL','UPLOAD-REPLAY-WINDOW-LOCAL','UPLOAD-WINDOW-HOST-LOCAL']
INDEX=ROOT/'.harness/window-host-workflow-index.json'
def step(tid):
    ...
    cp=checkpoint(ROOT,s['id'],'Read plan/NEXT_HOST_VERIFIED_SNAPSHOT.ja.md. Window-pinned private IPC and exclusive offline management are implemented; runtime optimization, live management, public/native transport, CRDT and writable recovery remain unverified.')
